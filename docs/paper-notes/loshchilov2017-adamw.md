...
- Evidence URLs: https://arxiv.org/abs/1711.05101; https://openreview.net/forum?id=Bkg6RiCqY7.
- Audit note: Separates weight decay from adaptive-gradient update; AdamW baseline for Muon comparisons.
