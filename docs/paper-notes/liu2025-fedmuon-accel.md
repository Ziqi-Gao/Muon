...
- Year: 2025
- Venue/status: arXiv
- URLs: https://arxiv.org/abs/2510.27403
- Identifiers: DOI=10.48550/arXiv.2510.27403; arXiv=2510.27403; OpenAlex=

## One-Sentence Role

Applies Muon locally in federated learning with alignment and momentum aggregation.
...
- Evidence URLs: https://arxiv.org/abs/2510.27403.
...
Add or verify paper node `liu2025-fedmuon-accel`, source row `liu2025-fedmuon-accel`, and typed graph edges to Muon, method variants, or concepts with source-backed confidence.
