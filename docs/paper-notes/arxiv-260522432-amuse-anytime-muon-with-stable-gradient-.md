# arxiv-260522432-amuse-anytime-muon-with-stable-gradient-
...
- URLs: https://arxiv.org/abs/2605.22432
- Identifiers: DOI=10.48550/arXiv.2605.22432; arXiv=2605.22432; OpenAlex=

## One-Sentence Role

Phase 2 audit on 2026-06-14: promoted from candidate/excluded because title/abstract evidence is directly about Muon, a Muon variant, or Muon orthogonalization. Evidence level: primary arXiv/web record opened. URL(s): https://arxiv.org/abs/2605.22432
...
- Evidence URLs: https://arxiv.org/abs/2605.22432.
...
Add or verify paper node `arxiv-260522432-amuse-anytime-muon-with-stable-gradient-`, source row `arxiv-260522432-amuse-anytime-muon-with-stable-gradient-`, and typed graph edges to Muon, method variants, or concepts with source-backed confidence.
