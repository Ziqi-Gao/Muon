# kovalev2025-gradient-orthogonalization
...
- Year: 2025
- Venue/status: arXiv
- URLs: https://arxiv.org/abs/2503.12645
- Identifiers: DOI=10.48550/arXiv.2503.12645; arXiv=2503.12645; OpenAlex=

## One-Sentence Role

Shows orthogonalized gradients as spectral-norm trust-region updates and recovers Muon as a special case.

## Core Ideas

First-pass extraction: Understanding Gradient Orthogonalization for Deep Learning via Non-Euclidean Trust-Region Optimization is tagged as Muon; non-Euclidean trust region; theory. It is included because it anchors the optimizer lineage, directly defines/analyzes Muon, or introduces a Muon-family variant.
...
Evidence source: https://arxiv.org/abs/2503.12645. This note is not yet a full paper read; it records discovery, role, and graph intent. Separate proved claims from empirical claims in the next phase.
...
- Evidence URLs: https://arxiv.org/abs/2503.12645.
- Audit note: Shows orthogonalized gradients as spectral-norm trust-region updates and recovers Muon as a special case.
