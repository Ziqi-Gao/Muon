...
- Year: 2026
- Venue/status: arXiv
- URLs: https://arxiv.org/abs/2604.09967
- Identifiers: DOI=; arXiv=2604.09967; OpenAlex=

## One-Sentence Role

Applies Adam-style second-moment preconditioning before orthogonalization to improve polar approximation.

## Core Ideas

First-pass extraction: Muon^2: Boosting Muon via Adaptive Second-Moment Preconditioning is tagged as Muon2; second-moment preconditioning; faster Newton-Schulz. It is included because it anchors the optimizer lineage, directly defines/analyzes Muon, or introduces a Muon-family variant.
...
Evidence source: https://arxiv.org/abs/2604.09967. This note is not yet a full paper read; it records discovery, role, and graph intent. Separate proved claims from empirical claims in the next phase.
...
- Evidence URLs: https://arxiv.org/abs/2604.09967.
- Audit note: Applies Adam-style second-moment preconditioning before orthogonalization to improve polar approximation.
