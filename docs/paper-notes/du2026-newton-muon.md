...
- Year: 2026
- Venue/status: arXiv
- URLs: https://arxiv.org/abs/2604.01472
- Identifiers: DOI=; arXiv=2604.01472; OpenAlex=

## One-Sentence Role

Derives Newton-Muon and interprets standard Muon as neglecting input second-moment right preconditioning.

## Core Ideas

First-pass extraction: The Newton-Muon Optimizer is tagged as Newton-Muon; surrogate model; right preconditioning. It is included because it anchors the optimizer lineage, directly defines/analyzes Muon, or introduces a Muon-family variant.
...
Evidence source: https://arxiv.org/abs/2604.01472. This note is not yet a full paper read; it records discovery, role, and graph intent. Separate proved claims from empirical claims in the next phase.
