# arxiv-260509991-optimizer-induced-mode-connectivity-from
...
- URLs: https://arxiv.org/abs/2605.09991
- Identifiers: DOI=10.48550/arXiv.2605.09991; arXiv=2605.09991; OpenAlex=

## One-Sentence Role

Phase 2 audit on 2026-06-14: promoted from candidate/excluded because title/abstract evidence is directly about Muon, a Muon variant, or Muon orthogonalization. Evidence level: primary arXiv URL retained from Phase 1 high-recall pool. URL(s): https://arxiv.org/abs/2605.09991
...
- Evidence URLs: https://arxiv.org/abs/2605.09991.
...
Add or verify paper node `arxiv-260509991-optimizer-induced-mode-connectivity-from`, source row `arxiv-260509991-optimizer-induced-mode-connectivity-from`, and typed graph edges to Muon, method variants, or concepts with source-backed confidence.
