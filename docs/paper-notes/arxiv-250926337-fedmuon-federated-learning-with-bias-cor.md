# arxiv-250926337-fedmuon-federated-learning-with-bias-cor
...
- URLs: https://arxiv.org/abs/2509.26337
- Identifiers: DOI=10.48550/arXiv.2509.26337; arXiv=2509.26337; OpenAlex=

## One-Sentence Role

Phase 2 audit on 2026-06-14: promoted from candidate/excluded because title/abstract evidence is directly about Muon, a Muon variant, or Muon orthogonalization. Evidence level: primary arXiv URL retained from Phase 1 high-recall pool. URL(s): https://arxiv.org/abs/2509.26337
...
- Evidence URLs: https://arxiv.org/abs/2509.26337.
...
Add or verify paper node `arxiv-250926337-fedmuon-federated-learning-with-bias-cor`, source row `arxiv-250926337-fedmuon-federated-learning-with-bias-cor`, and typed graph edges to Muon, method variants, or concepts with source-backed confidence.
